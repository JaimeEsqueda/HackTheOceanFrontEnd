...
<div class="oil_spills">
    <header>
        ...
        <nav class="medium2">
            ...
            <a href="#" class="grey bold2">Fecha</a>
            <a href="#" class="grey bold2">pais</a>
            <a href="#" class="grey bold2">estado</a>
            <a href="#" class="grey bold2">causa</a>
            <a href="#" class="white bold2">solucion</a>
        </nav>
    </header>
 </div>
